...
export const SCENE_WORDS = {
  tent: ["بيت الشعر", "bēt ash-shaʿar", "the goat-hair tent"],
  camels: ["الإبل", "al-ibil", "camels"],
  falcon: ["الصقر", "aṣ-ṣagr", "the falcon"],
  souq: ["السوق", "as-sūg", "the market"],
  roses: ["الورد", "al-ward", "roses"],
  coffee: ["القهوة", "al-gahwa", "coffee"],
  nafud: ["النفود", "an-nufūd", "the Nafud, the red sand desert"],
  mudhouse: ["بيت الطين", "bēt aṭ-ṭīn", "a mud-brick house"],
  majlis: ["المجلس", "al-majlis", "the majlis, the sitting room for guests"],
  sadu: ["السدو", "as-sadu", "Sadu weaving"],
  palms: ["النخل", "an-nakhl", "palm trees"],
  spring: ["الربيع", "ar-rabīʿ", "spring, when the desert turns green"],
  crescent: ["الهلال", "al-hilāl", "the new crescent moon"],
  qalam: ["القلم", "al-galam", "the pen"],
  diriyah: ["الدرعية", "ad-dirʿiyya", "Diriyah, the old capital"],
  rababa: ["الربابة", "ar-rabāba", "the rababa, a desert fiddle"],
  door: ["الباب", "al-bāb", "the door — Najdi doors are painted"],
  well: ["البير", "al-bīr", "the well"],
};

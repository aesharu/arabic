...
export const STORIES = [
  ...
  },
  {
    ...
    body: {
      ...
      najdi: "إذا جا مطر زين بالشتا، براري الشمال — حول حايل والجوف وعرعر وحفر الباطن — يطلع فيها الفقع، يطلعونه من الرمل آخر الشتا وبالربيع. ينباع بأسواق خاصة، وبالسنة الزينة يغلى حيل، وينشوى أو ينطبخ مع الرز.",
  ...
  },
  {
    ...
    body: {
      ...
      najdi: "شعر باللهجة، مب بالفصحى — قلب ثقافة نجد والشمال. الناس يستشهدون بالأبيات بالسوالف، ويرسلونها لبعض، ويتابعون مسابقات الشعر بالتلفزيون. والبيت الزين يكسب النقاش.",
  ...
  },
  {
    ...
    body: {
      ...
      najdi: "مب بس كبسة: الجريش — بر مجروش ينطبخ مع اللبن؛ والمرقوق — مرق خضار ولحم مع رقايق عجين؛ والقرصان — خبز رقيق مقطّع بالمرق؛ والمطازيز — قطع عجين بالمرق؛ وبالشتا الحنيني — تمر مهروس مع خبز وسمن. أغلبها ينسوّى بالبيت للعايلة.",
...
export const FACTS = [
  ...
  { en: "In Najdi, ق is usually said as “g”: gahwa (coffee), gāl (he said), galb (heart).", uk: "У наджді ق зазвичай вимовляють як «g»: gahwa (кава), gāl (він сказав), galb (серце).", najdi: "بالنجدي القاف غالبًا تنقال مثل حرف g بالإنجليزي: قهوة، قال، قلب.", msa: "في النجدية تُنطق القاف غالبًا كحرف g في الإنجليزية: قهوة، قال، قلب." },

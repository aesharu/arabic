...
// note {en, uk} comes from the plan's Note column. check = marked ⚠ in the plan.
...
export const PHRASES = [
  ...
  { day: 1, ar: "هلا والله", tr: "hala wallah", msa: "أهلاً وسهلاً", en: "hi!!", uk: "приві-іт!", note: { en: "Warm", uk: "Тепле привітання" } },

  { day: 2, ar: "كيفك؟", tr: "kēfik?", msa: "كيف حالك؟", en: "how are you?", uk: "як ти?", note: { en: "Same to him and her", uk: "Однаково до нього й до неї" } },
  { day: 2, ar: "الحمد لله", tr: "al-ḥamdu lillāh", msa: "الحمد لله", en: "good, thank God", uk: "добре, слава Богу", note: { en: "Standard answer", uk: "Стандартна відповідь" } },
  { day: 2, ar: "بخير", tr: "bikhēr", msa: "بخير", en: "fine", uk: "добре" },

  { day: 3, ar: "وش لونك؟", tr: "wesh lōnik?", msa: "كيف حالك؟", en: "how are you?", uk: "як ти?", note: { en: "Najdi classic, lit. “what's your colour”", uk: "Класика наджді, досл. «який твій колір»" } },
  ...
  { day: 4, ar: "تسلمين", tr: "tislamīn", msa: "شكراً لكِ", en: "thanks", uk: "дякую (до неї)", note: { en: "To her", uk: "До неї" } },
  { day: 4, ar: "تسلم", tr: "tislam", msa: "شكراً لكَ", en: "thanks", uk: "дякую (до нього)", note: { en: "To him — what she'll say to you", uk: "До нього — так вона казатиме тобі" } },
  ...
  { day: 8, ar: "عادي", tr: "ʿādi", msa: "لا بأس", en: "normal, it's fine", uk: "нормально, все гаразд", note: { en: "Hugely common", uk: "Дуже поширене" } },
  ...
  { day: 10, ar: "وش تسوين؟", tr: "wesh tsawwīn?", msa: "ماذا تفعلين؟", en: "what are you doing?", uk: "що ти робиш?", note: { en: "To her", uk: "До неї" } },
  { day: 10, ar: "وينك؟", tr: "wēnik?", msa: "أين أنتِ؟", en: "where are you?", uk: "де ти?", note: { en: "To her", uk: "До неї" } },
  ...
  { day: 11, ar: "ما شاء الله", tr: "mā shāʾ allah", msa: "ما شاء الله", en: "wow, great", uk: "ого, чудово", note: { en: "Praise that also wards off the evil eye", uk: "Похвала, яка ще й захищає від пристріту" } },
  { day: 11, ar: "يلا", tr: "yalla", msa: "هيا", en: "come on, let's go", uk: "давай, ходімо" },

  { day: 12, ar: "تصبحين على خير", tr: "tiṣbiḥīn ʿala khēr", msa: "تصبحين على خير", en: "good night", uk: "на добраніч", note: { en: "To her", uk: "До неї" } },
  { day: 12, ar: "وانتي من أهله", tr: "w inti min ahlah", msa: "وأنتِ من أهله", en: "reply to good night", uk: "відповідь на «на добраніч»", note: { en: "To her; she says وانت to you", uk: "До неї; тобі вона скаже وانت" } },
  { day: 12, ar: "في أمان الله", tr: "fi amān allah", msa: "في أمان الله", en: "bye (warm)", uk: "бувай (тепло)" },

  { day: 13, ar: "كيف أقول…؟", speak: "كيف أقول", tr: "kēf agūl…?", msa: "كيف أقول…؟", en: "how do I say …?", uk: "як сказати …?", note: { en: "Your most useful sentence", uk: "Твоє найкорисніше речення" } },
  { day: 13, ar: "وش معنى…؟", speak: "وش معنى", tr: "wesh maʿna…?", msa: "ما معنى…؟", en: "what does … mean?", uk: "що означає …?" },
  { day: 13, ar: "عيدي", tr: "ʿīdi", msa: "أعيدي من فضلك", en: "say it again", uk: "повтори", note: { en: "To her", uk: "До неї" } },

  { day: 14, ar: "الله يعطيك العافية", tr: "allah yiʿṭīk al-ʿāfya", msa: "أعطاكِ الله العافية", en: "“God give you strength”", uk: "«дай Боже сили»", note: { en: "When she's worked or done something", uk: "Коли вона попрацювала чи щось зробила" } },
  { day: 14, ar: "الله يعافيك", tr: "allah yʿāfīk", msa: "عافاك الله", en: "reply", uk: "відповідь" },
  { day: 14, ar: "أبشر / أبشري", speak: "أبشري", tr: "abshir / abshiri", msa: "حاضر", en: "consider it done (to him / to her)", uk: "вважай, що зроблено (до нього / до неї)", note: { en: "Very Saudi", uk: "Дуже по-саудівськи" } },
];

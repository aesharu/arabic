...
export const COMPLIMENTS = [
  ...
  { ar: "انتي مو بس حلوة، انتي عبقرية", en: "You're not just beautiful — you're a genius", uk: "Ти не просто гарна — ти геній", msa: "لستِ جميلة فحسب، بل عبقرية" },
  ...
  { ar: "انتي أذكى مني بكثير", en: "You're way smarter than me", uk: "Ти набагато розумніша за мене", msa: "أنتِ أذكى منّي بكثير" },
...
const SECTIONS = [
  ...
  { id: "love", title: { en: "I love you", uk: "Я тебе кохаю", najdi: "أحبك", msa: "أحبّكِ" }, items: [
    ...
    ["أحبك مرة", "aḥibbik marra", "I love you so much", "я тебе дуже кохаю", "أحبّكِ كثيرًا"],
  ...
  { id: "mind", title: { en: "Her mind and heart", uk: "Її розум і серце", najdi: "عقلها وقلبها", msa: "عقلها وقلبها" }, items: [
    ...
    ["تعلمت منك كثير", "tʿallamt minnik kithīr", "I've learned so much from you", "я так багато навчився в тебе", "تعلّمتُ منكِ كثيرًا"],
  ...
  { id: "daynight", title: { en: "Good morning, good night", uk: "Доброго ранку, на добраніч", najdi: "صباحها وليلها", msa: "تحيّات الصباح والمساء" }, items: [
    ...
    ["صبحك الله بالخير", "ṣabbaḥik allah bil-khēr", "good morning to you (lit. “may God give you a good morning”)", "доброго тобі ранку (досл. «хай Бог дасть тобі добрий ранок»)", "صبّحكِ الله بالخير"],
  ...
  { id: "sorry", title: { en: "Sorry and making up", uk: "Вибачення й примирення", najdi: "الاعتذار والمراضاة", msa: "الاعتذار والمصالحة" }, items: [
    ...
    ["راضية عني؟", "rāẓya ʿanni?", "are we okay now?", "ми помирились?", "هل تصالحنا؟"],
  ] },
  ...
  { id: "hers", title: { en: "What she may say to you", uk: "Що вона може сказати тобі", najdi: "اللي ممكن تقوله لك", msa: "ما قد تقوله لك" }, items: [
    ...
    ["يا حليلك", "ya ḥalīlak", "aww, how sweet (to a man)", "ой, який ти милий (до чоловіка)", "ما ألطفك", { note: HIM }],

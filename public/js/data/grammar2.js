...
export const GRAMMAR_A2 = [
  ...
  {
    id: "11",
    title: T("One, two, many", "Один, два, багато", "واحد، ثنين، كثير", "المفرد والمثنى والجمع"),
    intro: T(
  ...
  },
  {
    ...
    intro: T(
      ...
      "Саудівці часто кажуть, чиє щось, через حق (ḥagg): الجوال حقي — телефон мій. Він бере закінчення: حقي، حقك، حقها. Зі словом жіночого роду — حقت: السيارة حقت أبوي.",
      "بالسعودي نقول لمين الشي بـ«حق»: الجوال حقي. وتاخذ النهايات: حقي، حقك، حقها. والشي المؤنث حقت: السيارة حقت أبوي.",
      "تُستعمل في اللهجة السعودية «حقّ» للملكية: الجوال حقّي. وتتصل بها الضمائر: حقّي، حقّك، حقّها. ومع المؤنث «حقّت»: السيارة حقّت أبوي."),
    rows: rows([
  ...
  },
  {
    ...
    intro: T(
      ...
      "لازم + дієслово = треба: لازم أروح (мені треба йти). أقدر + дієслово = можу. يمدي / يمديك = є час, встигнеш (дуже по-саудівськи): يمديك تجين؟ ممكن = можливо; можна…?",
      "لازم + فعل: لازم أروح. أقدر + فعل: أقدر أجي. يمدي أو يمديك يعني فيه وقت وتلحق: يمديك تجين؟ وممكن: يمكن، أو «تسمح لي؟».",
      "«لازم» + فعل للوجوب، و«أقدر» + فعل للقدرة، و«يمدي/يمديك» أي يتّسع الوقت (سعودية): يمديك تجين؟ و«ممكن» للاحتمال أو الاستئذان."),
    rows: rows([
